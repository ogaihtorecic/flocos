...
class UsuarioController {
	...
	def login = {
    	...
    	if(usuario) {
    		...
    		redirect(action:"list", controller:"moaf")
    	} else {
	...
	def search = {
		def results = Usuario.findAllByLoginIlike("%" + params.criteria + "%", [max:10])
		render(view: "list", model: [usuarioInstanceList: results, usuarioInstanceTotal: Usuario.count()])
	}
}
