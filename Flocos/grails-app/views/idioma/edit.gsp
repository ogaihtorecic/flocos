                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="idioma"><g:message code="idioma.idioma.label" default="Idioma" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: idiomaInstance, field: 'idioma', 'errors')}">
                                    <g:textField name="idioma" maxlength="2" value="${idiomaInstance?.idioma}" />
                                </td>
                            </tr>
