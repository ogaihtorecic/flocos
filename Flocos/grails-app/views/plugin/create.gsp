                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="plugin"><g:message code="plugin.plugin.label" default="Plugin" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: pluginInstance, field: 'plugin', 'errors')}">
                                    <g:textField name="plugin" value="${pluginInstance?.plugin}" />
                                </td>
                            </tr>
