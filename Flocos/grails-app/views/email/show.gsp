            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="email.responsavel.label" default="Responsavel" /></td>
                            
                            <td valign="top" class="value"><g:link controller="responsavel" action="show" id="${emailInstance?.responsavel?.id}">${emailInstance?.responsavel?.encodeAsHTML()}</g:link></td>
