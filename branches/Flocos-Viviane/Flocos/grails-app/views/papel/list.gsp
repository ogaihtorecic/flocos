    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form name="searchForm" action="search">
            	<label for="criteria"><g:message code="papel.papel.label" default="Papel" /></label><br/>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="papel" title="${message(code: 'papel.papel.label', default: 'Papel')}" />
