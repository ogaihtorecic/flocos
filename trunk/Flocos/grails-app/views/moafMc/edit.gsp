    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form action="save" method="post" enctype="multipart/form-data">
              ...
              <g:hiddenField name="version" value="${moafMc?.version}" />
              <div id="tabs">
                  <ul>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: moafMc, field: 'dadosEducacionais', 'errors')}">
                                    <g:select style="width: 150px" id="semantics" name="dadosEducacionaisMc.semanticAnnotation" from="${moafMc?.dadosEducacionais?.semanticAnnotation}" optionValue="localAnotacao" optionKey="id" multiple="true" size="5" />
